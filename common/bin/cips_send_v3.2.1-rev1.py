...
# Current Version: 
#
# v3.2.1-rev1 :Modification Date: 2015/10/15 by RM : 
...
CIPSSTANDBY = "172.19.22.19"
CIPSOPER    = "172.19.22.19"
CIPS_HOSTS = [CIPSSTANDBY, CIPSOPER]
CIPS_LOGIN = "cips_in"
CIPS_PASSW = "cips_in"

CIPS_LOGIN = "rems"
CIPS_PASSW = "frodo1999"
...
def generateTransmetFilename(header, center, freeformat, date=None):
  ...
  if (_originalExtension):
    fileName = "T_"+header+"_C_"+center+"_"+date+"_"+freeformat
  else:
