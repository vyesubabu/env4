...
INTRODUCTION
     ...
     JDiskReport 1.3.1 requires Java 5 or later. At least 64 MB
...
INSTALLING AND RUNNING THE JAVA EDITION
     ...
     The Java-enabled edition comes as a ZIP archive that contains:
       ...
       o jdiskreport-1.3.1.jar - a signed executable JAR file
     ...
     where the JAR-file is located. Then execute:
        java -jar jdiskreport-1.3.1.jar
