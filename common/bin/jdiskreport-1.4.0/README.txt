...
INTRODUCTION
     ...
     JDiskReport 1.4.0 requires Java 5 or later. At least 64 MB
...
INSTALLING AND RUNNING THE JAVA EDITION
     ...
     The Java-enabled edition comes as a ZIP archive that contains:
       ...
       o jdiskreport-1.4.0.jar - a signed executable JAR file
...
------------------------------------------------------------------------
Copyright (c) 2000-2011 JGoodies Karsten Lentzsch. All rights reserved. 
